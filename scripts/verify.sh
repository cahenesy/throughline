...
#
# Runs the project's test suite and typecheck and exits 0 ONLY if both pass.
...
if [ "$TEST_CMD" = "__detect__" ] || [ "$TYPE_CMD" = "__detect__" ]; then
  det_test=""; det_type=""
...
fail=0
for stage in "test:$TEST_CMD" "typecheck:$TYPE_CMD"; do
